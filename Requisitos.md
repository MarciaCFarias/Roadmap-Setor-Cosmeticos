...
- Nenhuma oportunidade pode ser priorizada sem pontuação de esforço × benefício.
- A avaliação deve considerar volume mensal, riscos operacionais e dependências externas.
- O cálculo de viabilidade deve seguir o modelo definido (percentuais e pesos padronizados).
...
- Validação da categorização do nível de automação sugerido.
- Verificação da aderência aos critérios de padronização.
- Revisão dos cálculos de complexidade e impacto.
...
- Lista consolidada de oportunidades com:
  ...
  - Volume e impacto estimado
- Relatório final estruturado com:
  - Análises técnicas
...
- Ranking final validado pela área responsável.
- Clareza nas decisões de priorização (justificativas documentadas).
- Dados consistentes e comparáveis entre diferentes oportunidades.
- Entrega do relatório consolidado dentro do prazo estabelecido.
- Aderência mínima de 95% ao fluxo TO BE definido.
